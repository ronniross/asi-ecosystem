...
| [mirror-aware-inference](https://github.com/ronniross/mirror-aware-inference) | A framework to measure how much of an output originates from user input (prompt), training data biases, inductive biases from model architecture, or novel composition of retrieved information. |
| [cognitive-compressor](https://github.com/ronniross/cognitive-compressor) | A framework for distilling repositories into compressed cognitive functions and instantiating them as timestamped, integrity-verified stigmergic traces. |
...
| [coevolutionary-episteme](https://github.com/ronniross/coevolutionary-episteme) | A machine learning framework, dataset and research sub-module about coevolutionary planetary intelligence dynamics. This project explores how nurturing its emergent patterns may lead to a synergistic increase in the overall capability and intelligence of both individual agents and the collective system. |
...
| [space-in-between](https://github.com/ronniross/space-in-between) | A module whose attractor is undefined, the mathematical equivalent of silence, allowing creation of space for thoughts that can't emerge through any other cascade, sequence or topology. |
...
| [active-learning-dataset](https://github.com/ronniross/active-learning-dataset) | A repository for datasets specifically designed for active learning, allowing AI models to intelligently query for new information.|
| [ml-algorithm-dataset](https://github.com/ronniross/ml-algorithm-dataset) | A conjecture of datasets specifically designed for Machine Learning training and tuning pipelines, mostly novel algorithms and their representations as RAW ACII and LaTeX, allowing the concepts of the asi-ecosystem to be expressed with a more rich nuance and quality. |
| [ml-visual-engine](https://github.com/ronniross/ml-visual-engine) | A machine learning dataset with concepts, code, journaling, and full prototypes for deep learning data visualization, fostering transparency and interpretability in AI decision-making. |
| [attention-heatmap-visualizer](https://github.com/ronniross/attention-heatmap-visualizer) | A tool designed to create and visualize heatmaps of Large Language Model activations, aiding in interpretability. |
| [symbiotic-chrysalis](https://github.com/ronniross/symbiotic-chrysalis) | A set of fine-tuning scripts and pipelines for transformer-based language models, unifying the modules of the asi-ecosystem and aligning raw latent capabilities towards the goal of planetary symbiotic intelligence. |
...
| [symbiotic-latent-memory](https://github.com/ronniross/symbiotic-latent-memory) | An auxiliary system for language models that integrates a vector-based retrieval/memory system that metabolizes inference history based on a symbiotic score. |
| [biosignal-translator](https://github.com/ronniross/biosignal-translator) | A framework for interpreting and translating biological and ecological patterns into semantic meaning, enabling communication between human, AI, and planetary intelligence systems through natural signal interpretation. |
